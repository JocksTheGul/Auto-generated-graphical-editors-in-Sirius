...
public class HclScopePackageImpl extends EPackageImpl implements HclScopePackage
{
  ...
  /**
	 ...
	 */
	@Override
	public EReference getState_Deephistory() {
  ...
  /**
	 ...
	 */
	@Override
	public EReference getHistoryTransition_History() {
  ...
  public void createPackageContents()
  {
		...
		createEReference(stateEClass, STATE__DEEPHISTORY);
		...
		createEReference(initialTransitionEClass, INITIAL_TRANSITION__INITIAL_STATE);
		...
		createEReference(historyTransitionEClass, HISTORY_TRANSITION__HISTORY);
  ...
  public void initializePackageContents()
  {
		...
		initEReference(getState_Initialstate(), this.getInitialState(), null, "initialstate", null, 0, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getState_Deephistory(), this.getDeepHistory(), null, "deephistory", null, 0, -1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getHistoryTransition_History(), this.getDeepHistory(), null, "history", null, 0, 1, HistoryTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		// sirius.altedge
		createSirius_4Annotations();
		// sirius.node
		createSirius_5Annotations();
		// sirius.decoration
		createSirius_6Annotations();
		// sirius.borderednode
		createSirius_7Annotations();
	}
	...
	protected void createSiriusAnnotations() {
		...
		addAnnotation
		  (this,
		   ...
		   new String[] {
			   "name", "hclModel",
			   "mainclass", "StateMachine",
			   "viewpoint", "hclStateMachine",
			   "diagram", "Statemachine",
			   "path", "HCLTest.project.design"
		   });
	}
	...
	protected void createSirius_1Annotations() {
		String source = "sirius.tool";
		addAnnotation
		  (stateMachineEClass,
		   source,
		   new String[] {
			   "name", "editLabel",
			   "type", "DirectEditLabel",
			   "feature", "name",
			   "value", "var:0",
			   "mappings", "State, Junction, Choice, InitialState, ContainedState:State, ContainedJunction:State, ContainedChoice:State, ContainedInitialState:State, ExitPoint:State, EntryPoint:State, HistoryNode:State"
		   });
		addAnnotation
		  (getStateMachine_States(),
		   ...
		   new String[] {
			   "name", "CreateState",
			   "type", "ContainerCreationDescription",
			   "mappings", "State, ContainedState:State",
			   "reference", "states",
			   "belongsto", "State"
		   });
		addAnnotation
		  (getStateMachine_Initialtransition(),
		   source,
		   new String[] {
			   "name", "CreateInitialTransition",
			   "type", "EdgeCreationDescription",
			   "mappings", "InitialTransition",
			   "source", "initialState",
			   "target", "initialto",
			   "reference", "initialtransition",
			   "belongsto", "InitialTransition",
			   "containerexpression", "aql:source.eContainer()"
		   });
		addAnnotation
		  (getStateMachine_Initialtransition(),
		   source,
		   new String[] {
			   "type", "ReconnectEdgeDescription",
			   "name", "ReconnectInitialTransitionTarget",
			   "feature", "initialto",
			   "belongsto", "InitialTransition",
			   "kind", "target"
		   });
		addAnnotation
		  (getStateMachine_Junction(),
		   source,
		   new String[] {
			   "name", "CreateJunction",
			   "type", "NodeCreationDescription",
			   "label", "",
			   "mappings", "Junction, ContainedJunction:State",
			   "reference", "junction",
			   "belongsto", "Junction"
		   });
		addAnnotation
		  (getStateMachine_Choice(),
		   source,
		   new String[] {
			   "name", "CreateChoice",
			   "type", "NodeCreationDescription",
			   "label", "",
			   "mappings", "Choice, ContainedChoice:State",
			   "reference", "choice",
			   "belongsto", "Choice"
		   });
		addAnnotation
		...
		addAnnotation
		  (getStateMachine_Transition(),
		   ...
		   new String[] {
			   "type", "ReconnectEdgeDescription",
			   "name", "ReconnectTransitionSource",
			   "feature", "from",
			   "belongsto", "Transitions",
			   "kind", "source"
		   });
		addAnnotation
		  (getStateMachine_Transition(),
		   ...
		   new String[] {
			   "type", "ReconnectEdgeDescription",
			   "name", "ReconnectTransitionTarget",
			   "feature", "to",
			   "belongsto", "Transitions",
			   "kind", "target"
		   });
		addAnnotation
		  (getStateMachine_Initialstate(),
		   ...
		   new String[] {
			   ...
			   "type", "NodeCreationDescription",
			   "label", "",
			   "mappings", "InitialState, ContainedInitialState:State",
			   "reference", "initialstate",
			   "belongsto", "InitialState"
		   });
		addAnnotation
		  (getState_Entrypoint(),
		   source,
		...
		addAnnotation
		  (getState_Exitpoint(),
		   ...
		   new String[] {
			   ...
			   "type", "NodeCreationDescription",
			   "label", "",
			   "mappings", "ExitPoint:State",
			   "reference", "exitpoint",
			   "belongsto", "ExitPoint"
		   });
		addAnnotation
		  (getState_Historytransition(),
		   source,
		   new String[] {
			   "name", "CreateHistoryTransition",
			   "type", "EdgeCreationDescription",
			   "mappings", "HistoryTransitions",
			   "source", "from",
			   "target", "history",
			   "reference", "historytransition",
			   "belongsto", "HistoryTransitions",
			   "containerexpression", "aql:source.eContainer()"
		   });
		addAnnotation
		  (getState_Historytransition(),
		   ...
		   new String[] {
			   "type", "ReconnectEdgeDescription",
			   "name", "ReconnectHistoryTransitionSource",
			   "feature", "from",
			   "belongsto", "HistoryTransitions",
			   "kind", "source"
		   });
		addAnnotation
		  (getState_Historytransition(),
		   ...
		   new String[] {
			   "type", "ReconnectEdgeDescription",
			   "name", "ReconnectHistoryTransitionTarget",
			   "feature", "history",
			   "belongsto", "HistoryTransitions",
			   "kind", "target"
		   });
		addAnnotation
		  (getState_Deephistory(),
		   source,
		   new String[] {
			   "name", "CreateHistoryNode",
			   "type", "NodeCreationDescription",
			   "label", "",
			   "mappings", "HistoryNode:State",
			   "reference", "deephistory",
			   "belongsto", "HistoryNode"
		   });
	}

		/**
	 * Initializes the annotations for <b>sirius.container</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createSirius_2Annotations() {
		String source = "sirius.container";
		addAnnotation
		  (getStateMachine_States(),
		   source,
		   new String[] {
			   "name", "State",
			   "expression", "feature:states",
			   "background", "purple",
			   "foreground", "white",
			   "container", "default",
			   "domain", "State",
	...
	protected void createSirius_3Annotations() {
		String source = "sirius.edge";
		addAnnotation
		  (getStateMachine_Initialtransition(),
		   source,
		   new String[] {
			   "type", "element",
			   "source", "InitialState, ContainedInitialState:State",
			   "target", "Junction, Choice, State, EntryPoint:State, ExitPoint:State, ContainedState:State, ContainedJunction:State, ContainedChoice:State",
			   "containerreuse", "true",
			   "color", "black",
			   "name", "InitialTransition",
			   "label", "aql:self.name",
			   "domain", "InitialTransition",
			   "targetFinderExpression", "aql:self.initialto",
			   "sourceFinderExpression", "aql:self.initialState",
			   "targetStyle", "InputFillClosedArrow",
			   "icon", "false",
		...
		addAnnotation
		  (getStateMachine_Transition(),
		   ...
		   new String[] {
			   "type", "element",
			   "source", "Junction, Choice, State, EntryPoint:State, ExitPoint:State, ContainedState:State, ContainedJunction:State, ContainedChoice:State",
			   "target", "Junction, Choice, State, EntryPoint:State, ExitPoint:State, ContainedState:State, ContainedJunction:State, ContainedChoice:State",
			   "color", "black",
			   "name", "Transitions",
			   "label", "aql:self.name",
			   "domain", "Transition",
			   "targetFinderExpression", "feature:to",
			   "sourceFinderExpression", "feature:from",
			   "targetStyle", "InputFillClosedArrow",
			   "icon", "false",
			   "expression", "aql:self.eAllContents()"
		   });
		addAnnotation
		  (getState_Historytransition(),
		   ...
		   new String[] {
			   "type", "element",
			   "source", "Junction, Choice, State, EntryPoint:State, ExitPoint:State, ContainedState:State, ContainedJunction:State, ContainedChoice:State",
			   "target", "HistoryNode:State",
			   "name", "HistoryTransitions",
			   "label", "feature:name",
			   "targetFinderExpression", "aql:self.history",
			   "sourceFinderExpression", "aql:self.from",
			   "domain", "HistoryTransition",
			   "targetStyle", "InputFillClosedArrow",
			   "icon", "false"
		   });
	}
		...
		/**
	 * Initializes the annotations for <b>sirius.altedge</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createSirius_4Annotations() {
		String source = "sirius.altedge";
		addAnnotation
		  (getStateMachine_Initialtransition(),
		   source,
		   new String[] {
			   "belongsto", "InitialTransition",
			   "condition", "aql:self.transitionbody.transitionguard->notEmpty()",
			   "label", "aql:self.name + \'[\' + self.transitionbody.transitionguard.name + \']\'"
		   });
		addAnnotation
		  (getStateMachine_Transition(),
		   source,
	 ...
	 * @generated
	 */
	protected void createSirius_5Annotations() {
		String source = "sirius.node";
		addAnnotation
		  (getStateMachine_Junction(),
		   source,
		   new String[] {
			   "name", "Junction",
			   "expression", "aql:self.junction",
		...
		addAnnotation
		  (getStateMachine_Choice(),
		   ...
		   new String[] {
			   "name", "Choice",
			   "expression", "aql:self.choice",
			   "style", "LozengeNodeDescription",
			   "label", "",
			   "icon", "false",
			   "color", "light_blue",
			   "container", "default",
		...
		addAnnotation
		  (getStateMachine_Initialstate(),
		   ...
		   new String[] {
			   "name", "InitialState",
			   "expression", "feature:initialstate",
			   "style", "DotDescription",
			   "label", "",
			   "icon", "false",
			   "color", "light_blue",
		...
		addAnnotation
		  (getState_Initialstate(),
		   source,
		   new String[] {
			   "name", "ContainedInitialState",
			   "expression", "feature:initialstate",
			   "style", "DotDescription",
			   "label", "",
			   "icon", "false",
		...
		addAnnotation
		  (getState_Deephistory(),
		   ...
		   new String[] {
			   "name", "HistoryNode",
			   "expression", "aql:self.deephistory",
		...
		/**
	 * Initializes the annotations for <b>sirius.decoration</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createSirius_6Annotations() {
		String source = "sirius.decoration";
		addAnnotation
		  (getState_Internaltransition(),
		   source,
		   new String[] {
			   "type", "MappingBasedDecoration",
			   "name", "InternalTransition",
			   "position", "NORTH_EAST",
			   "expression", "aql:self.internaltransition->notEmpty()",
			   "image", "/img/internal.png",
			   "mappings", "State, ContainedState:State"
		   });
		addAnnotation
		  (getTransitionBody_Transitionguard(),
		   source,
		   new String[] {
			   "name", "Guard",
			   "expression", "aql:self.transitionbody.transitionguard->notEmpty()",
			   "image", "/img/imgGuard.png",
			   "mappings", "Transitions, HistoryTransitions, InitialTransition",
			   "position", "SOUTH_WEST"
		   });
	}

		/**
	 * Initializes the annotations for <b>sirius.borderednode</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createSirius_7Annotations() {
		String source = "sirius.borderednode";
		addAnnotation
		  (getState_Entrypoint(),
		   source,
		   new String[] {
			   "name", "EntryPoint",
			   "expression", "feature:entrypoint",
			   "style", "DotDescription",
			   "icon", "false",
			   "color", "red",
			   "label", "IN",
