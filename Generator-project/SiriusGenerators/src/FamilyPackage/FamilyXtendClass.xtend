...
public class FamilyXtendClass {
	...
	{
		val BasicfamilyFactory = BasicfamilyFactory.eINSTANCE;
		val gen = new FamilyGenerator
		
		val temp = BasicfamilyPackage.eINSTANCE;
...
class FamilyGenerator extends AbstractGenerator {
	...
	override doGenerate(Resource input, IFileSystemAccess2 fsa, IGeneratorContext context) {
		...
		val MetaModel = BasicfamilyPackage.eINSTANCE;
		fsa.generateFile(MetaModel.name + ".odesign", MetaModel.compile)
	}
	
	public def compile(BasicfamilyPackage mmPackage) '''
	...
	private def getMainClass(BasicfamilyPackage mmPackage)
	{	//Function to get the main class
		...
		private def getPath(BasicfamilyPackage mmPackage)
	{	//Function to get the main class
		//Can use the package directly to access the sirius annotation
		//as the sirius annotation is not connected to any element
		val contents = mmPackage.EAnnotations
	...
	private def getViewpoint(BasicfamilyPackage mmPackage)
	{	
		val contents = mmPackage.EAnnotations
		for(i : 0 ..< contents.size())
		{	
		...
		private def getExtension(BasicfamilyPackage mmPackage)
	{	
		val contents = mmPackage.EAnnotations
		for(i : 0 ..< contents.size())
		{	
	...
	private def getDiagram(BasicfamilyPackage mmPackage)
	{	
		val contents = mmPackage.EAnnotations
		for(i : 0 ..< contents.size())
		{	
	...
	private def getNodes(BasicfamilyPackage mmPackage)
	{
	...
	private def getAllNodes(BasicfamilyPackage mmPackage)
	{
		//Get the contents of the package
		val contents = mmPackage.eAllContents.toList()
		//New list to contain the nodes
		...
		private def getAllContainers(BasicfamilyPackage mmPackage)
	{
		//Get the contents of the package
		val contents = mmPackage.eAllContents.toList()
		//New list to contain the nodes
	...
	private def getContainers(BasicfamilyPackage mmPackage)
	{
		//Get the contents of the package
		val contents = mmPackage.eAllContents.toList()
	...
	private def getContainerContents(BasicfamilyPackage mmPackage, String name)
	{
		val contents = mmPackage.eAllContents.toList()
	...
	private def getContentsString(EAnnotationImpl annotation, BasicfamilyPackage mmPackage)
	{
		//If it finds an element that has the node annotation add it to the list
	...
	private def getContainedContentsString(EAnnotationImpl annotation, BasicfamilyPackage mmPackage)
	{
		//If it finds an element that has the node annotation add it to the list
		if(annotation.source == "sirius.borderednode")
		{
	...
	private def getBorderedNodeString(EAnnotationImpl objectAnnotation, BasicfamilyPackage mmPackage)'''
	...
	private def getSubNodeString(EAnnotationImpl objectAnnotation, BasicfamilyPackage mmPackage)'''
	...
	'''
	private def getSubContainerString(EAnnotationImpl objectAnnotation, BasicfamilyPackage mmPackage)'''
	...
	private def getToolsAnnotation(BasicfamilyPackage mmPackage, String tool, String name, EAnnotation objectAnnotation)
	{
		val contents = mmPackage.eAllContents.toList
		for(i : 0 ..< contents.size())
		{
	...
	private def getDoubleClickToolString(BasicfamilyPackage mmPackage, EAnnotationImpl objectAnnotation)'''
	...
	private def getReconnectionTools(BasicfamilyPackage mmPackage, String tool, String name)
	{
		val contents = mmPackage.eAllContents.toList
	...
	private def getUniversalTool(BasicfamilyPackage mmPackage, String tool)
	{
		val contents = mmPackage.eAllContents.toList
		for(i : 0 ..< contents.size())
		{
	...
	private def getUniversalToolGroup(BasicfamilyPackage mmPackage, String tool)
	{
		val contents = mmPackage.eAllContents.toList
	...
	private def getEdges(BasicfamilyPackage mmPackage)
	{
		val contents = mmPackage.eAllContents.toList
	...
	private def getMappingString(BasicfamilyPackage mmPackage, EAnnotationImpl objectAnnotation, String search)
	{
		var str = ""
	...
	private def getReusedContainers(BasicfamilyPackage mmPackage)
	{
		val contents = mmPackage.eAllContents.toList
	...
	private def getContainerString(BasicfamilyPackage mmPackage, EObject o, EAnnotationImpl objectAnnotation)
	{
			val contents = mmPackage.eAllContents.toList
			for(c : 0 ..< contents.size())
			{
		...
		private def getContainerStringSearch(BasicfamilyPackage mmPackage, EAnnotationImpl objectAnnotation, String search)
	{
			val contents = mmPackage.eAllContents.toList
			for(c : 0 ..< contents.size())
			{
	...
	private def getAlternateEdge(BasicfamilyPackage mmPackage, EAnnotationImpl objectAnnotation)
	{
		val contents = mmPackage.eAllContents.toList
		var str = ""
		for(c : 0 ..< contents.size())
	...
	private def getAlternateNode(BasicfamilyPackage mmPackage, EAnnotationImpl objectAnnotation)
	{
		val contents = mmPackage.eAllContents.toList
		var str = ""
		for(c : 0 ..< contents.size())
	...
	private def getDecorations(BasicfamilyPackage mmPackage)
	{
		val contents = mmPackage.eAllContents.toList
		var arr = newArrayList
		for(c : 0 ..< contents.size())
	...
	private def getDecorationString(ArrayList<EAnnotationImpl> arr, BasicfamilyPackage mmPackage) '''
