...
public class HCLGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource input, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    final HclScopePackage MetaModel = HclScopePackage.eINSTANCE;
    String _name = MetaModel.getName();
    String _plus = (_name + ".odesign");
    fsa.generateFile(_plus, this.compile(MetaModel));
  }
  
  public CharSequence compile(final HclScopePackage mmPackage) {
  ...
  private String getMainClass(final HclScopePackage mmPackage) {
  ...
  private String getPath(final HclScopePackage mmPackage) {
    final EList<EAnnotation> contents = mmPackage.getEAnnotations();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private String getViewpoint(final HclScopePackage mmPackage) {
    final EList<EAnnotation> contents = mmPackage.getEAnnotations();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private String getExtension(final HclScopePackage mmPackage) {
    final EList<EAnnotation> contents = mmPackage.getEAnnotations();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private String getDiagram(final HclScopePackage mmPackage) {
    final EList<EAnnotation> contents = mmPackage.getEAnnotations();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private ArrayList<EObject> getNodes(final HclScopePackage mmPackage) {
  ...
  private ArrayList<EObject> getAllNodes(final HclScopePackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    final ArrayList<EObject> nodes = CollectionLiterals.<EObject>newArrayList();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private ArrayList<EObject> getAllContainers(final HclScopePackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    final ArrayList<EObject> nodes = CollectionLiterals.<EObject>newArrayList();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private ArrayList<EObject> getContainers(final HclScopePackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private ArrayList<EAnnotationImpl> getContainerContents(final HclScopePackage mmPackage, final String name) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private CharSequence getContentsString(final EAnnotationImpl annotation, final HclScopePackage mmPackage) {
    String _source = annotation.getSource();
  ...
  private CharSequence getContainedContentsString(final EAnnotationImpl annotation, final HclScopePackage mmPackage) {
    String _source = annotation.getSource();
    boolean _equals = Objects.equal(_source, "sirius.borderednode");
    if (_equals) {
      return this.getBorderedNodeString(annotation, mmPackage);
  ...
  private CharSequence getBorderedNodeString(final EAnnotationImpl objectAnnotation, final HclScopePackage mmPackage) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private CharSequence getSubNodeString(final EAnnotationImpl objectAnnotation, final HclScopePackage mmPackage) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private CharSequence getSubContainerString(final EAnnotationImpl objectAnnotation, final HclScopePackage mmPackage) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private EAnnotationImpl getToolsAnnotation(final HclScopePackage mmPackage, final String tool, final String name, final EAnnotation objectAnnotation) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private CharSequence getDoubleClickToolString(final HclScopePackage mmPackage, final EAnnotationImpl objectAnnotation) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private ArrayList<EAnnotationImpl> getReconnectionTools(final HclScopePackage mmPackage, final String tool, final String name) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private EAnnotationImpl getUniversalTool(final HclScopePackage mmPackage, final String tool) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private ArrayList<EAnnotationImpl> getUniversalToolGroup(final HclScopePackage mmPackage, final String tool) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private ArrayList<EObject> getEdges(final HclScopePackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private String getMappingString(final HclScopePackage mmPackage, final EAnnotationImpl objectAnnotation, final String search) {
    String str = "";
  ...
  private ArrayList<EAnnotationImpl> getReusedContainers(final HclScopePackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private Object getContainerString(final HclScopePackage mmPackage, final EObject o, final EAnnotationImpl objectAnnotation) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer c : _doubleDotLessThan) {
  ...
  private Object getContainerStringSearch(final HclScopePackage mmPackage, final EAnnotationImpl objectAnnotation, final String search) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer c : _doubleDotLessThan) {
  ...
  private String getAlternateEdge(final HclScopePackage mmPackage, final EAnnotationImpl objectAnnotation) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    String str = "";
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private String getAlternateNode(final HclScopePackage mmPackage, final EAnnotationImpl objectAnnotation) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    String str = "";
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private CharSequence getAlternateNodeString(final EAnnotationImpl AlternateNode, final EAnnotationImpl SourceNode) {
    ...
    _builder.newLine();
    {
      if ((alternateColor != null)) {
        _builder.append("        \t");
        String _nodeColorString = this.getNodeColorString(AlternateNode);
        _builder.append(_nodeColorString, "        \t");
        _builder.newLineIfNotEmpty();
      } else {
        _builder.append("        \t");
        String _nodeColorString_1 = this.getNodeColorString(SourceNode);
        _builder.append(_nodeColorString_1, "        \t");
        _builder.newLineIfNotEmpty();
      }
    }
    _builder.append("\t");
  ...
  private CharSequence getDecorations(final HclScopePackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    ArrayList<EAnnotationImpl> arr = CollectionLiterals.<EAnnotationImpl>newArrayList();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private CharSequence getDecorationString(final ArrayList<EAnnotationImpl> arr, final HclScopePackage mmPackage) {
    StringConcatenation _builder = new StringConcatenation();
