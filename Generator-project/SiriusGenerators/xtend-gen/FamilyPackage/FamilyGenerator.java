...
public class FamilyGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource input, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    final BasicfamilyPackage MetaModel = BasicfamilyPackage.eINSTANCE;
    String _name = MetaModel.getName();
    String _plus = (_name + ".odesign");
    fsa.generateFile(_plus, this.compile(MetaModel));
  }
  
  public CharSequence compile(final BasicfamilyPackage mmPackage) {
  ...
  private String getMainClass(final BasicfamilyPackage mmPackage) {
  ...
  private String getPath(final BasicfamilyPackage mmPackage) {
    final EList<EAnnotation> contents = mmPackage.getEAnnotations();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private String getViewpoint(final BasicfamilyPackage mmPackage) {
    final EList<EAnnotation> contents = mmPackage.getEAnnotations();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private String getExtension(final BasicfamilyPackage mmPackage) {
    final EList<EAnnotation> contents = mmPackage.getEAnnotations();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private String getDiagram(final BasicfamilyPackage mmPackage) {
    final EList<EAnnotation> contents = mmPackage.getEAnnotations();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private ArrayList<EObject> getNodes(final BasicfamilyPackage mmPackage) {
  ...
  private ArrayList<EObject> getAllNodes(final BasicfamilyPackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    final ArrayList<EObject> nodes = CollectionLiterals.<EObject>newArrayList();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private ArrayList<EObject> getAllContainers(final BasicfamilyPackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    final ArrayList<EObject> nodes = CollectionLiterals.<EObject>newArrayList();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private ArrayList<EObject> getContainers(final BasicfamilyPackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private ArrayList<EAnnotationImpl> getContainerContents(final BasicfamilyPackage mmPackage, final String name) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private CharSequence getContentsString(final EAnnotationImpl annotation, final BasicfamilyPackage mmPackage) {
    String _source = annotation.getSource();
  ...
  private CharSequence getContainedContentsString(final EAnnotationImpl annotation, final BasicfamilyPackage mmPackage) {
    String _source = annotation.getSource();
    boolean _equals = Objects.equal(_source, "sirius.borderednode");
    if (_equals) {
      return this.getBorderedNodeString(annotation, mmPackage);
  ...
  private CharSequence getBorderedNodeString(final EAnnotationImpl objectAnnotation, final BasicfamilyPackage mmPackage) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private CharSequence getSubNodeString(final EAnnotationImpl objectAnnotation, final BasicfamilyPackage mmPackage) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private CharSequence getSubContainerString(final EAnnotationImpl objectAnnotation, final BasicfamilyPackage mmPackage) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private EAnnotationImpl getToolsAnnotation(final BasicfamilyPackage mmPackage, final String tool, final String name, final EAnnotation objectAnnotation) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private CharSequence getDoubleClickToolString(final BasicfamilyPackage mmPackage, final EAnnotationImpl objectAnnotation) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private ArrayList<EAnnotationImpl> getReconnectionTools(final BasicfamilyPackage mmPackage, final String tool, final String name) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private EAnnotationImpl getUniversalTool(final BasicfamilyPackage mmPackage, final String tool) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer i : _doubleDotLessThan) {
  ...
  private ArrayList<EAnnotationImpl> getUniversalToolGroup(final BasicfamilyPackage mmPackage, final String tool) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private ArrayList<EObject> getEdges(final BasicfamilyPackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private String getMappingString(final BasicfamilyPackage mmPackage, final EAnnotationImpl objectAnnotation, final String search) {
    String str = "";
  ...
  private ArrayList<EAnnotationImpl> getReusedContainers(final BasicfamilyPackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
  ...
  private Object getContainerString(final BasicfamilyPackage mmPackage, final EObject o, final EAnnotationImpl objectAnnotation) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer c : _doubleDotLessThan) {
  ...
  private Object getContainerStringSearch(final BasicfamilyPackage mmPackage, final EAnnotationImpl objectAnnotation, final String search) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
    for (final Integer c : _doubleDotLessThan) {
  ...
  private String getAlternateEdge(final BasicfamilyPackage mmPackage, final EAnnotationImpl objectAnnotation) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    String str = "";
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private String getAlternateNode(final BasicfamilyPackage mmPackage, final EAnnotationImpl objectAnnotation) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    String str = "";
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private CharSequence getDecorations(final BasicfamilyPackage mmPackage) {
    final List<EObject> contents = IteratorExtensions.<EObject>toList(mmPackage.eAllContents());
    ArrayList<EAnnotationImpl> arr = CollectionLiterals.<EAnnotationImpl>newArrayList();
    int _size = contents.size();
    ExclusiveRange _doubleDotLessThan = new ExclusiveRange(0, _size, true);
  ...
  private CharSequence getDecorationString(final ArrayList<EAnnotationImpl> arr, final BasicfamilyPackage mmPackage) {
    StringConcatenation _builder = new StringConcatenation();
